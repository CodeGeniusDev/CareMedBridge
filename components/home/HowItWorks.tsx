          ...
          <div className="relative">
            ...
            <ol className="relative grid grid-cols-6 gap-6">
              {processSteps.map((step, i) => (
                <li key={step.number} className="relative flex flex-col items-center text-center pt-16">
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-10 flex h-16 w-16 items-center justify-center rounded-2xl border border-white/15 bg-[var(--color-navy)]">
          ...
          <ol className="relative flex flex-col gap-5">
            ...
            {processSteps.map((step, i) => (
              <li key={step.number} className="relative flex items-start gap-5">
                <div className="absolute -top-4 left-0 z-10 flex h-16 w-16 items-center justify-center rounded-2xl border border-white/15 bg-[var(--color-navy)]">
                  <step.icon className="h-6 w-6 text-[var(--color-accent)]" />
                  <span className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-[var(--color-accent)] text-[10px] font-bold text-[var(--color-navy)]">
                    {step.number}
                  </span>
