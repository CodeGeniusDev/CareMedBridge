...
export const services: Service[] = [
  {
    ...
    detail: {
      ...
      howWeHelp: [
        { title: "A dedicated billing team", description: "You get an assigned billing team that learns your practice, your payers, and your workflows instead of a rotating queue of strangers." },
      ...
      workflow: [
        { title: "Charge capture & intake", description: "Encounter data flows in from your EHR, practice management system, or daily uploads, whichever fits your workflow." },
      ...
      faqs: [
        ...
        { question: "How do you charge for medical billing services?", answer: "Most practices choose a percentage-of-collections model, so our fee scales with the revenue we actually collect for you. Flat-fee arrangements are also available. Every quote is custom, and you can see details on our pricing page." },
      ],
  ...
  },
  {
    ...
    detail: {
      ...
      workflow: [
        { title: "Chart review", description: "We read the encounter documentation thoroughly and never code from a charge slip alone." },
  ...
  },
  {
    ...
    detail: {
      ...
      howWeHelp: [
        { title: "One accountable partner", description: "A single team owns your revenue cycle end to end, with no finger-pointing between vendors when something goes wrong." },
        ...
        { title: "Front-to-back coverage", description: "Eligibility verification and prior auth at the front, denial management and AR recovery at the back, and everything in between included." },
      ...
      workflow: [
        ...
        { title: "Charge capture & coding", description: "Every encounter is coded accurately and captured completely, with nothing billable missed." },
      ...
      faqs: [
        ...
        { question: "How is RCM different from medical billing alone?", answer: "Billing is one stage of the cycle. RCM manages the whole flow, from front-end patient access through back-end collections and analytics, so problems get prevented upstream instead of worked downstream." },
  ...
  },
  {
    ...
    detail: {
      ...
      challenges: [
        { title: "Coverage changes go unnoticed", description: "Patients switch employers, plans, and carriers, and last month's information is often stale." },
      ...
      howWeHelp: [
        { title: "Verification before every visit", description: "Each scheduled patient is verified in advance, with coverage status, effective dates, and plan type confirmed." },
      ...
      faqs: [
        ...
        { question: "Can you handle same-day or walk-in patients?", answer: "Yes. We can verify on the day of service for urgent add-ons, although advance verification always produces the smoothest experience." },
        { question: "Does eligibility verification replace prior authorization?", answer: "No. Verification confirms coverage, while authorization obtains payer approval for specific services. The two work together, which is why we flag auth requirements during verification." },
      ],
  ...
  },
  {
    ...
    detail: {
      ...
      howWeHelp: [
        ...
        { title: "Rejection management", description: "Rejections are corrected and resubmitted quickly instead of being discovered weeks later during reconciliation." },
      ],
      workflow: [
      ...
      faqs: [
        ...
        { question: "What is claim scrubbing?", answer: "A pre-submission review that checks claims for missing information, invalid code combinations, and payer-specific requirements, catching problems while they are still cheap to fix." },
  ...
  },
  {
    ...
    detail: {
      ...
      challenges: [
        { title: "Appeal windows close fast", description: "Payer appeal deadlines are often measured in days. Miss one, and the revenue is usually gone." },
      ...
      howWeHelp: [
        ...
        { title: "Root-cause analysis", description: "Denials are grouped by cause, including coding, eligibility, documentation, and timely filing, to reveal systemic fixes." },
      ...
      workflow: [
        { title: "Denial intake", description: "Denials are captured from payer remits and portals as they arrive instead of being handled only at month-end." },
      ...
      faqs: [
        { question: "What types of denials do you handle?", answer: "All of them, including coding denials, eligibility issues, medical necessity, documentation requests, timely filing, coordination of benefits, and more, each with the appropriate correction or appeal path." },
  ...
  },
  {
    ...
    detail: {
      ...
      howWeHelp: [
        ...
        { title: "Smart prioritization", description: "Worklists rank claims by value, age, and recoverability so effort goes where the return is." },
        ...
        { title: "Clean resolution tracking", description: "Every account is documented, including what is owed, what is blocking it, and when it is resolved." },
      ],
      workflow: [
      ...
      faqs: [
        ...
        { question: "How do you report progress?", answer: "You'll see starting balances, follow-up activity, recoveries, and remaining AR, along with aging trends so you can watch the cleanup take effect." },
  ...
  },
  {
    ...
    detail: {
      ...
      challenges: [
        ...
        { title: "CAQH and attestations", description: "Profiles need constant upkeep, and one lapsed attestation can freeze multiple enrollments." },
      ...
      faqs: [
        ...
        { question: "How long does payer enrollment take?", answer: "Timelines vary by payer and can run from a few weeks to a few months. We control what we can, including complete, accurate applications and persistent follow-up, to keep things moving." },
  ...
  },
  {
    ...
    detail: {
      ...
      challenges: [
        ...
        { title: "Delayed patient care", description: "When auth isn't ready in time, procedures reschedule and patients wait, which hurts care and revenue." },
      ],
      howWeHelp: [
      ...
      faqs: [
        ...
        { question: "How far in advance should auth requests be submitted?", answer: "As early as the procedure is planned, because payer review times vary widely and early submission leaves room for escalation if a request stalls." },
  ...
  },
  {
    ...
    detail: {
      ...
      workflow: [
        ...
        { title: "Reporting", description: "Posting activity feeds your monthly reports, including collections, adjustments, and trends." },
      ],
      benefits: [
      ...
      faqs: [
        { question: "Do you post both insurance and patient payments?", answer: "Yes. ERAs and EOBs from insurers, patient payments from statements and portals, and secondary remittances are all posted to the correct accounts." },
  ...
  },
  {
    ...
    detail: {
      ...
      howWeHelp: [
        { title: "Dedicated assigned assistants", description: "You work with the same trained assistants, people who learn your practice instead of a ticket queue." },
