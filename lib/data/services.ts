...
export const services: Service[] = [
  {
    ...
    detail: {
      overview: [
        ...
        "CareMedBridge provides full-service medical billing for physicians, private practices, clinics, and hospitals across the USA. Our billing specialists manage the complete lifecycle, including charge entry, coding review, claim submission, payment posting, denial follow-up, and patient statements, as a seamless extension of your practice.",
      ],
      challenges: [
        {
          title: "Coding and data entry errors",
          description:
            "Small mistakes in demographics, codes, or modifiers trigger rejections and force costly rework.",
        },
        {
          title: "Constantly changing payer rules",
          description:
        ...
        {
          title: "Staff turnover and training costs",
          description:
      ...
      howWeHelp: [
        {
          title: "A dedicated billing team",
          description:
            "You get an assigned billing team that learns your practice, your payers, and your workflows instead of a rotating queue of strangers.",
        },
        {
      ...
      workflow: [
        {
          title: "Charge capture & intake",
          description:
            "Encounter data flows in from your EHR, practice management system, or daily uploads, whichever fits your workflow.",
        },
        {
          title: "Coding review & claim creation",
          description:
        ...
        {
          title: "Denial management & patient statements",
          description:
      ...
      benefits: [
        ...
        "More time for medicine and less time on the phone with payers",
      ],
      faqs: [
        {
          question: "What does full-service medical billing include?",
          answer:
        ...
        {
          question:
            "Can you take over billing mid-year from our current setup?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Most practices choose a percentage-of-collections model, so our fee scales with the revenue we actually collect for you. Flat-fee arrangements are also available. Every quote is custom, and you can see details on our pricing page.",
        },
      ],
  ...
  },
  {
    ...
    detail: {
      ...
      challenges: [
        {
          title: "Enormous code set complexity",
          description:
        ...
        {
          title: "Specialty-specific rules",
          description:
      ...
      workflow: [
        {
          title: "Chart review",
          description:
            "We read the encounter documentation thoroughly and never code from a charge slip alone.",
        },
        {
      ...
      faqs: [
        {
          question: "Which code sets do your coders work with?",
          answer:
        ...
        {
          question: "Can you code for our specialty?",
          answer:
        ...
        {
          question: "Do you provide coding only, or bundled with billing?",
          answer:
        ...
        {
          question:
            "How do you handle documentation that doesn't support a code?",
          answer:
  ...
  },
  {
    ...
    description:
      "We manage your entire revenue cycle, from patient access and charge capture to claims management and collections, delivering consistent cash flow and financial transparency.",
    icon: "TrendingUp",
    ...
    detail: {
      ...
      howWeHelp: [
        {
          ...
          description:
            "A single team owns your revenue cycle end to end, with no finger-pointing between vendors when something goes wrong.",
        },
        {
        ...
        {
          title: "Front-to-back coverage",
          description:
            "Eligibility verification and prior auth at the front, denial management and AR recovery at the back, and everything in between included.",
        },
        {
      ...
      workflow: [
        ...
        },
        {
          ...
          description:
            "Every encounter is coded accurately and captured completely, with nothing billable missed.",
        },
        {
      ...
      faqs: [
        {
          question: "What's included in your RCM services?",
          answer:
        ...
        {
          question: "How is RCM different from medical billing alone?",
          answer:
            "Billing is one stage of the cycle. RCM manages the whole flow, from front-end patient access through back-end collections and analytics, so problems get prevented upstream instead of worked downstream.",
        },
        {
          question: "Will we keep visibility into our financials?",
          answer:
        ...
        {
          question: "Do you support multi-specialty groups?",
          answer:
  ...
  },
  {
    ...
    detail: {
      overview: [
        "A surprising share of claim denials trace back to the front end: coverage that lapsed, benefits that ran out, or a service the patient's plan simply doesn't cover. Insurance eligibility verification catches these problems before the visit, when they are still easy and inexpensive to fix.",
      ...
      challenges: [
        {
          title: "Coverage changes go unnoticed",
          description:
            "Patients switch employers, plans, and carriers, and last month's information is often stale.",
        },
        {
          title: "Manual checks eat staff time",
          description:
            "Phone calls and portal logins for every patient consume hours your front desk doesn't have.",
        },
        {
          title: "Benefit details get missed",
          description:
            "Deductibles, visit limits, and referral requirements are easy to overlook until a denial arrives.",
        },
        {
          title: "Surprise patient balances",
          description:
      ...
      howWeHelp: [
        {
          title: "Verification before every visit",
          description:
            "Each scheduled patient is verified in advance, with coverage status, effective dates, and plan type confirmed.",
        },
        {
          title: "Detailed benefit capture",
          description:
            "We pull copays, deductibles, coinsurance, and coverage limits so your team knows what to collect at check-in.",
        },
        {
          title: "Prior-auth flagging",
          description:
      ...
      faqs: [
        {
          question: "How far in advance do you verify patients?",
          answer:
        ...
        {
          question: "What exactly do you verify?",
          answer:
        ...
        {
          question: "Can you handle same-day or walk-in patients?",
          answer:
            "Yes. We can verify on the day of service for urgent add-ons, although advance verification always produces the smoothest experience.",
        },
        {
          question:
            "Does eligibility verification replace prior authorization?",
          answer:
            "No. Verification confirms coverage, while authorization obtains payer approval for specific services. The two work together, which is why we flag auth requirements during verification.",
        },
      ],
      relatedSlugs: [
  ...
  },
  {
    ...
    detail: {
      overview: [
        "Claim submission looks simple from the outside: assemble the claim, hit send, and wait for payment. In practice, every payer has its own edits, format requirements, and quirks, and a claim that fails first-pass scrutiny can lose weeks in limbo before anyone notices.",
      ...
      howWeHelp: [
        ...
        },
        {
          ...
          description:
            "Rejections are corrected and resubmitted quickly instead of being discovered weeks later during reconciliation.",
        },
      ],
      workflow: [
        {
          title: "Claim assembly",
          description:
      ...
      faqs: [
        {
          question: "Which payers can you submit claims to?",
          answer:
        ...
        },
        {
          ...
          answer:
            "A pre-submission review that checks claims for missing information, invalid code combinations, and payer-specific requirements, catching problems while they are still cheap to fix.",
        },
        {
          question: "How quickly are claims submitted after service?",
          answer:
            "Claims are prepared and submitted on a daily workflow, so charges don't accumulate and filing windows are never at risk.",
        },
        {
          question: "What happens when a claim is rejected?",
          answer:
  ...
  },
  {
    ...
    detail: {
      overview: [
        "Denied claims are rarely the end of the story, but they become lost revenue when no one has time to analyze them, appeal them, and fix what caused them. Effective denial management services treat every denial as both a recovery opportunity and a data point for prevention.",
      ...
      challenges: [
        {
          title: "Appeal windows close fast",
          description:
            "Payer appeal deadlines are often measured in days. Miss one, and the revenue is usually gone.",
        },
        {
          title: "Root causes stay hidden",
          description:
            "Without categorization and analysis, the same denial types recur month after month.",
        },
        {
          title: "Appeals are labor-intensive",
          description:
            "Strong appeals require documentation gathering, payer-specific arguments, and persistent follow-up.",
        },
        {
          title: "Denials quietly become write-offs",
          description:
      ...
      howWeHelp: [
        ...
        },
        {
          ...
          description:
            "Denials are grouped by cause, including coding, eligibility, documentation, and timely filing, to reveal systemic fixes.",
        },
        {
        ...
        {
          title: "Prevention feedback loops",
          description:
      ...
      workflow: [
        {
          title: "Denial intake",
          description:
            "Denials are captured from payer remits and portals as they arrive instead of being handled only at month-end.",
        },
        {
      ...
      faqs: [
        {
          ...
          answer:
            "All of them, including coding denials, eligibility issues, medical necessity, documentation requests, timely filing, coordination of benefits, and more, each with the appropriate correction or appeal path.",
        },
        {
          question: "How quickly do you work denials?",
          answer:
        ...
        {
          question: "Can you reduce our denial rate long-term?",
          answer:
        ...
        {
          question:
            "Do you handle both commercial and government payer denials?",
          answer:
  ...
  },
  {
    ...
    detail: {
      overview: [
        "Accounts receivable is money your practice has already earned. It is just sitting in payer queues, appeal loops, or unworked follow-up piles. Aging AR rarely resolves itself, and without systematic attention, balances get adjusted away or quietly abandoned.",
      ...
      howWeHelp: [
        ...
        },
        {
          ...
          description:
            "Worklists rank claims by value, age, and recoverability so effort goes where the return is.",
        },
        {
          title: "Persistent payer follow-up",
          description:
            "Calls, portal checks, and re-submissions continue until every claim reaches resolution.",
        },
        {
          title: "Clean resolution tracking",
          description:
            "Every account is documented, including what is owed, what is blocking it, and when it is resolved.",
        },
      ],
      workflow: [
        {
      ...
      faqs: [
        {
          question: "Can you work a one-time AR cleanup project?",
          answer:
        ...
        {
          question: "How old can AR be and still be recoverable?",
          answer:
        ...
        },
        {
          ...
          answer:
            "You'll see starting balances, follow-up activity, recoveries, and remaining AR, along with aging trends so you can watch the cleanup take effect.",
        },
        {
          question: "Do you also prevent new AR from piling up?",
          answer:
  ...
  },
  {
    ...
    detail: {
      overview: [
        ...
        "CareMedBridge handles the credentialing lifecycle end to end, including initial payer enrollments, CAQH profile maintenance, re-credentialing cycles, and ongoing monitoring of expiration dates, so your providers stay billable and your practice avoids coverage gaps.",
      ],
      challenges: [
        {
          title: "Lengthy payer timelines",
          description:
            "Enrollment applications can take weeks to months, and errors restart the clock.",
        },
        {
          title: "Payer-specific requirements",
          description:
            "Every insurer wants the same information in a different format, with different supporting documents.",
        },
        {
          title: "CAQH and attestations",
          description:
            "Profiles need constant upkeep, and one lapsed attestation can freeze multiple enrollments.",
        },
        {
          title: "Expiring credentials",
          description:
            "Licenses, board certifications, and re-credentialing cycles expire on their own schedules.",
        },
      ],
      howWeHelp: [
        {
          ...
          description:
            "We prepare, submit, and track applications with payers, following up persistently until approval.",
        },
        {
          title: "CAQH profile upkeep",
          description:
            "Your CAQH profiles stay current and attested, so payer rosters never stall on outdated data.",
        },
        {
          title: "Re-credentialing handled",
          description:
            "Re-credentialing cycles are tracked and completed before payers interrupt your billing.",
        },
        {
          title: "Expiration monitoring",
          description:
            "Licenses, certifications, and enrollment renewals are calendarized with advance alerts.",
        },
      ],
      workflow: [
        {
          ...
          description:
            "Provider demographics, licenses, education, and work history are gathered into complete files.",
        },
        {
          title: "Application submission",
          description:
            "Payer and CAQH applications are prepared accurately and submitted without delays.",
        },
        {
          title: "Payer follow-up",
          description:
            "We track application status with each payer and resolve requests for additional information.",
        },
        {
          title: "Approval & effective dates",
          description:
            "Enrollment confirmations and effective dates are documented so billing starts on time.",
        },
        {
          title: "Ongoing maintenance",
          description:
            "Re-credentialing cycles and expirables are monitored continuously, with renewals started early.",
        },
      ],
      benefits: [
      ...
      faqs: [
        {
          question: "What credentialing services do you provide?",
          answer:
            "Initial payer enrollment for new providers, CAQH profile setup and maintenance, re-credentialing cycles, roster maintenance, and monitoring of licenses and expiring credentials.",
        },
        {
          question: "How long does payer enrollment take?",
          answer:
            "Timelines vary by payer and can run from a few weeks to a few months. We control what we can, including complete, accurate applications and persistent follow-up, to keep things moving.",
        },
        {
          question: "Can you credential a newly graduated provider?",
          answer:
            "Yes. We assemble the file from their training and licensure history and manage enrollments from day one so billing can begin as early as payer effective dates allow.",
        },
        {
          question: "Do you track re-credentialing deadlines?",
          answer:
            "Yes. Re-credentialing cycles and license expirations are calendared with advance notice, and renewals are started well before deadlines.",
        },
      ],
      relatedSlugs: [
        "front-office-management",
  ...
  },
  {
    ...
    detail: {
      overview: [
        "Prior authorization requirements keep expanding, with more procedures, more drugs, and more payer scrutiny. For practices, that means hours of portal work, documentation assembly, and status chasing. For patients, it can mean delayed care. Prior authorization services exist to keep that process moving without burying your staff.",
      ...
      challenges: [
        ...
        },
        {
          ...
          description:
            "When auth isn't ready in time, procedures reschedule and patients wait, which hurts care and revenue.",
        },
      ],
      howWeHelp: [
        {
      ...
      workflow: [
        ...
        {
          title: "Criteria & documentation check",
          description:
      ...
      benefits: [
        ...
        "Daily visibility into auth status with no black holes",
        "Decisions documented with numbers and valid dates",
        "Smoother patient experience around planned care",
      ],
      faqs: [
        {
          question: "Which services typically need prior authorization?",
          answer:
        ...
        {
          question: "How far in advance should auth requests be submitted?",
          answer:
            "As early as the procedure is planned, because payer review times vary widely and early submission leaves room for escalation if a request stalls.",
        },
        {
          question: "Do you handle urgent or expedited authorizations?",
          answer:
            "Yes. Urgent clinical situations are flagged and worked through expedited channels with immediate follow-up.",
        },
        {
          question: "What happens if an auth is denied?",
          answer:
        ...
        {
          question:
            "Can you handle medication and specialty drug authorizations?",
          answer:
  ...
  },
  {
    ...
    detail: {
      overview: [
        "Payment posting is where your revenue cycle meets reality: every remittance, adjustment, and patient payment lands here. When posting is slow or inaccurate, everything downstream, including AR follow-up, denial detection, and financial reporting, works from bad information.",
      ...
      workflow: [
        ...
        },
        {
          title: "Reporting",
          description:
            "Posting activity feeds your monthly reports, including collections, adjustments, and trends.",
        },
      ],
      benefits: [
      ...
      faqs: [
        {
          question: "Do you post both insurance and patient payments?",
          answer:
            "Yes. ERAs and EOBs from insurers, patient payments from statements and portals, and secondary remittances are all posted to the correct accounts.",
        },
        {
  ...
  },
  {
    ...
    detail: {
      overview: [
        "Healthcare administration has a way of expanding until it consumes every free hour your team has. Virtual assistance gives your practice trained, dedicated support for repetitive work such as data entry, follow-ups, scheduling support, and documentation tasks without another full-time local hire.",
      ...
      challenges: [
        {
          title: "Staff burnout and turnover",
          description:
            "Repetitive admin work burns out good employees and drives expensive turnover.",
        },
        {
          title: "Hiring costs keep climbing",
          description:
            "Salary, benefits, training, and office space make each local hire a major commitment.",
        },
        {
          title: "Work falls through the cracks",
          description:
            "Follow-ups, faxes, and data entry pile up when the day runs out of hours.",
        },
        {
          title: "Coverage gaps",
          description:
            "Sick days, vacations, and vacancies leave your practice exposed at the worst times.",
        },
      ],
      howWeHelp: [
        {
          title: "Dedicated assigned assistants",
          description:
            "You work with the same trained assistants, people who learn your practice instead of a ticket queue.",
        },
        {
          title: "Flexible task coverage",
          description:
            "From data entry and scheduling support to patient follow-up calls and document management.",
        },
        {
          title: "Supervised and managed",
          description:
            "Assistants are trained, managed, and quality-checked, so performance doesn't depend on luck.",
        },
        {
          title: "Transparent productivity",
          description:
            "Clear reporting shows what's been completed, so you always know your coverage is real.",
        },
      ],
      workflow: [
        {
          ...
          description:
            "We map the admin work consuming your team and define what the assistant will own.",
        },
        {
          title: "Workflow setup",
          description:
            "Secure access, tools, and procedures are established to match your practice's processes.",
        },
        {
          title: "Daily execution",
          description:
            "Your assistant completes assigned tasks on a defined schedule with check-ins as needed.",
        },
        {
          title: "Review & reporting",
          description:
            "Completed work is reviewed for quality and reported so coverage stays visible.",
        },
      ],
      benefits: [
        "Lower cost than hiring locally for the same coverage",
        "Your in-house team refocused on patients, not paperwork",
        "Consistent, dedicated support without a rotating temp pool",
      ...
      faqs: [
        {
          question: "What tasks can a medical virtual assistant handle?",
          answer:
            "Common assignments include scheduling support, insurance calls, data entry, document management, patient follow-ups, and referral coordination, scoped with you during setup.",
        },
        {
          question: "How do you protect patient information?",
          answer:
            "Access is scoped to assigned tasks, assistants work under confidentiality obligations, and we align with your practice's security policies. Ask us about safeguards during your consultation.",
        },
        {
          question: "Can the assistant work inside our systems?",
          answer:
            "Yes, with your authorization, assistants work inside your EHR, PM system, and other practice tools under your existing workflows.",
        },
        {
          question: "How is pricing structured for virtual assistance?",
          answer:
            "Typically a flat monthly rate based on hours and task scope. We'll define the coverage during consultation and quote accordingly.",
        },
      ],
      relatedSlugs: [
        "front-office-management",
  ...
  },
  {
    ...
    detail: {
      ...
      challenges: [
        {
          ...
          description:
            "Phones ring constantly, and every missed call is a potentially missed appointment.",
        },
        {
          title: "Registration errors",
          description:
            "One wrong member ID or birth date follows a claim all the way to a denial.",
        },
        {
          title: "Schedule gaps and no-shows",
          description:
            "Unmanaged scheduling leaks revenue through empty slots every single day.",
        },
        {
          title: "Front desk overload",
          description:
            "Checking in patients while verifying benefits and answering phones is more than one person can do well.",
        },
      ],
      howWeHelp: [
        {
          ...
          description:
            "Appointment calls, reminders, and patient questions are answered promptly and professionally.",
        },
        {
          title: "Accurate registration",
          description:
            "Demographics and insurance details are captured carefully and verified at entry.",
        },
        {
          title: "Proactive scheduling support",
          description:
            "Confirmation calls and reminder workflows keep schedules full and no-shows down.",
        },
        {
          title: "Insurance checks at the front",
          description:
            "Eligibility is verified before visits, so collections at check-in are accurate.",
        },
      ],
      workflow: [
        {
          ...
          description:
            "We map your current front-office operations and identify where support has the most impact.",
        },
        {
          title: "Setup & training",
          description:
            "Scripts, procedures, and system access are established to match your practice's standards.",
        },
        {
          title: "Daily operations",
          description:
            "Scheduling, registration, verification, and call handling run on a consistent daily rhythm.",
        },
        {
          title: "Quality review",
          description:
            "Accuracy and responsiveness are monitored and reported, so standards stay high.",
        },
      ],
      benefits: [
      ...
      faqs: [
        {
          question: "What does front office management cover?",
          answer:
            "Appointment scheduling, patient registration, insurance eligibility verification, call handling, reminders, and daily front-desk workflows, scoped to your practice's needs.",
        },
        {
          question: "Will patients know they're talking to an outside team?",
          answer:
            "No. Our team answers as your practice, following your scripts and standards, so the experience is seamless.",
        },
        {
          question:
            "Can you support our existing phone system and scheduling software?",
          answer:
            "In most cases, yes. We review your systems during consultation and design the coverage around the tools you already use.",
        },
        {
          question: "How does this connect with your billing services?",
          answer:
            "Perfectly. Clean registration and verification at the front end is the foundation of clean claims, and the two services share the same data flow.",
        },
      ],
      relatedSlugs: [
        "insurance-eligibility-verification",
