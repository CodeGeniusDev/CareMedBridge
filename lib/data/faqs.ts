...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Onboarding timelines vary based on practice size and complexity. Most practices are fully onboarded and submitting claims within 2 to 4 weeks. We work closely with your team to make the transition as smooth as possible.",
    category: "Process",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    answer:
      "We offer flexible pricing models, including percentage-of-collections and flat-fee arrangements, depending on your practice size and service needs. All pricing is custom-quoted following a complimentary consultation, and there are no one-size-fits-all rates.",
    category: "Pricing",
  },
  {
    id: "8",
  ...
  },
  {
    ...
    answer:
      "Clean, complete claims are typically submitted within 24 to 72 hours of receiving documentation, depending on your practice's workflow and payer requirements. Faster, accurate submission shortens the payment cycle and keeps cash flow predictable.",
    category: "Process",
  },
  {
    id: "13",
  ...
  },
  {
    ...
    answer:
      "You get clear, regular reporting on the metrics that matter: claims submitted and paid, denial rates, AR aging, days in AR, and collections by payer. Reports are designed for practice owners and office managers, with actionable, easy-to-read summaries delivered on a consistent schedule.",
    category: "Process",
  },
  {
    id: "15",
